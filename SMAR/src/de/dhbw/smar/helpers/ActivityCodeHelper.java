...
public class ActivityCodeHelper {
	public static int ACTIVITY_LOGIN_REQUEST = 1;
	public static int ACTIVITY_INITCONFIG_REQUEST = 2;
	public static int ACTIVITY_BARCODE_REQUEST = 3;
	...
	public static String ACTIVITY_INSERTPRODUCT_DESTROY = "de.dhbw.smar.InsertProduct.destroy";
}
